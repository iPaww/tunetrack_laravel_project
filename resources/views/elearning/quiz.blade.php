...
<div class="card topic-card">
    <div class="card-body row">
        <div class="col-4 border-end">
            ...
            @endforeach
            <a class="text-reset text-decoration-none" data-bs-toggle="collapse" href="quiz" role="button"
            ...
            @if (count($quizes) > 0)
                @if ($started)
                    ...
                    <p class="text-break text-justify fw-semibold">
                        ...
                        the experience.
                        We encourage honest participation to ensure accurate tracking of your progress and to foster a
                        genuine sense of achievement. There are no time limits imposed, giving you the flexibility to
                        engage at your own pace and focus on quality rather than speed.
                        Your progress is being carefully monitored and recorded, both to help you track your milestones
                        and to maintain a secure and equitable environment for all users.
                        If you are ready to proceed and agree to abide by these rules, please log in to your account to
                        continue your journey. Your commitment to fair practices will enrich not only your experience
                        but also help us understand in which we can improve.
                    </p>
