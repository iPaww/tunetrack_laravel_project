...
<div class="d-flex flex-column flex-md-row">
    <aside class="side-bar">
        <nav class="menu-ctgry">
            <a class="text-reset text-decoration-none" href="/profile/learning"><div class="instruments-ctgry">My Courses</div></a>
            <a class="text-reset text-decoration-none" href="/profile/exam"><div class="instruments-ctgry">Assesments</div></a>
